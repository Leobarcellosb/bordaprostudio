...
-- Drop both overloaded versions and recreate a single smart version
DROP FUNCTION IF EXISTS public.search_designs(text, uuid, text, integer, integer, text, integer, integer);
DROP FUNCTION IF EXISTS public.search_designs(text, uuid, text, integer, integer, text, integer, integer, text);
