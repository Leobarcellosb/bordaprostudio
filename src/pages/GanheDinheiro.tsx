...
const FAQ = [
  ...
  { q: "Posso indicar qualquer pessoa?", a: "Pode! Qualquer pessoa que realmente vá usar a Borda Pro conta. O que o termo proíbe é autoindicação e contas criadas só pra gerar comissão (mesmo CPF/Pix, perfis falsos, duplicadas) — isso o antifraude bloqueia." },
