...
export const AppSidebar = () => {
  ...
  return (
    <aside className="hidden md:flex flex-col w-[17rem] bg-sidebar text-sidebar-foreground h-screen sticky top-0 border-r border-sidebar-border overflow-y-auto">
      {/* Brand */}
      <div className="h-[90px] px-6 flex items-center border-b border-sidebar-border">
        <img src={logoHorizontal} alt="Borda Pro — Biblioteca de Matrizes" className="h-10 w-[150px] object-contain object-left" />
      </div>
